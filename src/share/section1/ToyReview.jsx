        ...
        <div className='mb-12'>
            ...
            <div className='lg:flex gap-24 p-24'>
                <div className='mt-24 space-y-4'>
                    <p className='text-accent'>Save 50% on purchase</p>
                ...
                <img className='w-96 h-96 rounded-2xl shadow-2xl hover:w-[464px] hover:h-[464px]' src="https://i.ibb.co/J2pC18y/images-15.jpg" alt="" />
            </div>
        </div>
    );
};
